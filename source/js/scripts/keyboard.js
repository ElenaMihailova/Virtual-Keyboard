import keysBase from './keyBase.js';
...
class Keyboard {
  ...
  renderKeyboard() {
    ...
    keyboard.classList.add('keyboard__groupe', 'keys');

    this.container.appendChild(keyboard);

    this.keysBase.forEach((keysRowData) => {
      const keysRow=document.createElement('div');

      keysRow.classList.add('keys__row');
      ...
      keysRowData.forEach((keyData) => {
        ...
        const key=new Key(keysRow, keyData.keyCode, keyData.label, keyData.secondLabel, keyData.isCase? this.isLowerCase:false, isActive, keyHandler);
